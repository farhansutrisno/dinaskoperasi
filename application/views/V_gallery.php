...
<body>
            ...
            <div class="menu">
              <nav id="main-menu" class="main-menu">
                <ul>
                  ...
                  <li class="active"><a href="<?php echo base_url() ?>C_frontEnd/lihatGambar">Galeri</a></li>                     
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="page-heading">
            <h1>Galeri Bidang Kelembagaan Koperasi</h1>
          </div>
        </div>        
      </div>
    </div>
  ...
  <div class="gallery-page-sec pt-100 pb-70"> 
    <div class="container">
      <div class="row">   
          ...
          <div class="gallery-container">  
              ...
              <div class="col-xs-6 col-sm-4 col-md-3 ">
                <div class="gallery-item">
                  <h2 align="justify"><?php echo $key->judul; ?></h2>
                  <img src="<?php echo base_url() ?>gambar_proyek/<?php echo $key->gambar ?>" width="200px" hright="300px" alt="" />
