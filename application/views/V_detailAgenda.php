					...
					<div class="media">	
						<div class="single-post">	
							<div class="single-post-thumb">	
								<img src="<?php echo base_url().'gambar_proyek/'.$agenda[0]->gambar ?>" width="450px" height="550px" align="center" alt=""/>									
							</div>	
							<div class="blog-text">
								<div class="post-info">
									<h2 align="justify"><?php echo $agenda[0]->agenda ?></h2>													
								</div>								
								<p align="justify"><?php echo $agenda[0]->isiAgendaKerja ?>.</p>	
							</div>
							<a href="<?php echo base_url().'C_frontEnd/lihatFrontEnd'?>" class="blog-readmore">Kembali</a>							
						</div>				
					</div>								
				</div>
			</div>
