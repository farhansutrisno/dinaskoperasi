...
<body>
  <div  id="notifications"><?php echo $this->session->flashdata('pesan8'); ?></div>
  <div  id="notifications"><?php echo $this->session->flashdata('pesan9'); ?></div>
  <!-- Preloader Start -->
  <div id="preloader">
            ...
            <div class="menu">
              <nav id="main-menu" class="main-menu">
                <ul>
                  ...
                  <li class="active"><a href="<?php echo base_url() ?>C_frontEnd/kirimPesan">Kontak</a></li>
                </ul>
              </nav>
            </div>          
          </div>  
      ...
      <div class="row">    
        <div class="col-md-8">         
          <div class="contact-field">
            <form action="<?php echo base_url()?>webbackend/C_dataKoperasi/prosesInputPengunduh2" method="POST" name="kirimPesan">
            <div class="row">
              <div class="col-md-12">
                <h2>Data Pengunduh</h2>
              </div>
              ...
              <div class="col-md-8 col-sm-8 col-xs-12">
                <div class="single-input-field">
                  <input required placeholder="E-mail" type="email" name="email" value="<?php echo set_value('email') ?>">
                  <?php echo form_error('email'); ?>
                </div>
              </div>              
              <div class="col-md-8 col-sm-8 col-xs-12">
                <div class="single-input-field">
                  <input required placeholder="No Telepon" type="number" name="noTelepon" value="<?php echo set_value('noTelepon') ?>">
                  <?php echo form_error('noTelepon'); ?>
                </div>
              </div>             
              <div class="col-md-12 message-input">
                <div class="single-input-field">
                  <textarea required placeholder="Alamat" name="alamat"><?php echo set_value('alamat') ?></textarea>
              ...
              <div class="col-md-12">
                <div class="single-input-fieldsbtn">
                  ...
                  <?php echo anchor('webbackend/C_datakoperasi/lihatDataKoperasi2','KEMBALI',array('class'=>'btn btn-round btn-info'));?>
                </div>              
              </div>              
            </div>      
            </form>
