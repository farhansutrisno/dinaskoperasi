...
<body>
  ...
  <div class="contact-page-sec pt-100 pb-70">
    <div class="container">
      <div class="row"> 
        <div class="col-md-4 contact-page-sidebar">       
          <div class="contact-info">
            <div class="contact-info-item">
              ...
              <div class="contact-info-text">
                <h2>Alamat</h2>
                <span>Jl. Soekarno - Hatta No. 705 Bandung, Jawa Barat 40286</span> 
              </div>
            </div>            
          </div>          
          <div class="contact-info">
            <div class="contact-info-item">
              ...
              <div class="contact-info-text">
                <h2>E-mail</h2>
                <span>diskumkm@jabarprov.go.id</span> 
              </div>
            </div>            
          </div>      
        </div>   
        <div class="col-md-8">
          ...
          <div class="contact-field">
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="single-input-field">
                  <input required placeholder="Judul Pesan" type="text" name="judulPesan" value="<?php echo set_value('judulPesan') ?>">
                  <?php echo form_error('judulPesan'); ?>
                </div>
              </div>                   
              <div class="col-md-12 message-input">
                <div class="single-input-field">
                  <textarea required placeholder="Isi Pesan" name="isiPesan"><?php echo set_value('isiPesan') ?></textarea>
