              ...
              <div class="media"> 
                <div class="single-post"> 
                  <div class="single-post-thumb"> 
                    <img src="<?php echo base_url() ?>gambar_proyek/<?php echo $key->gambar ?>" width="300px" hright="380px" alt=""/>  
                    <div class="post-date">
                      <div class="post-date-middle">
                        <span><?php echo $key->tanggalBerita; ?></span>
                      </div>
                    </div>
                  </div>  
                  <div class="blog-text">
                    <div class="post-info">
                      <h2 align="justify"><a href="blog-details.html"><?php echo $key->judul; ?></a></h2>
                      <p><?php echo word_limiter($key->narasi,8); ?></p>                        
                    </div>        
                    <a href="<?php echo base_url().'C_frontEnd/detailBerita/'.$key->kdBerita?>" class="blog-readmore">Baca Berita</a>
                  </div>        
                </div>        
              </div>        
            </div> 
