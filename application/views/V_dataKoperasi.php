            ...
            <div class="menu">
              <nav id="main-menu" class="main-menu">
                <ul>
                  ...
                  <li class="active"><a href="#">Informasi</a>
                    <ul>
  ...
  <div class="contact-page-sec pt-100 pb-70">
    <div class="container">
      <div class="row"> 
        ...
        <form action="<?php echo base_url().'webbackend/C_dataKoperasi/filter' ?>" method="post">  
          <?php
          echo anchor('webbackend/C_dataKoperasi/inputPengunduh','Export Data All',array('class'=>'btn btn-round btn-success'))
          ?>
          <?php
          echo anchor('webbackend/C_dataKoperasi/inputPengunduh2','Export Data Filter',array('class'=>'btn btn-round btn-success'))
          ?>
          <input type="submit" name="submit" value="FILTER" class="btn btn-round btn-success pull-right">
          <select class="form-control pull-right" style="height: 33px; width: 150px;" name="jenisKoperasi">
            <option value="">Jenis Koperasi</option> 
            <?php foreach($jenis as $key) { ?>
                <option value="<?php echo $key->jenisKoperasi;?>"><?php echo $key->jenisKoperasi;?></option>
            <?php } ?>
          </select>
          <select class="form-control pull-right" style="height: 33px; width: 150px;" name="kabupaten">
            <option value="">Kabupaten</option> 
            <?php foreach($kabupaten as $key) { ?>
                <option value="<?php echo $key->kabupaten;?>"><?php echo $key->kabupaten;?></option>
            <?php } ?>
          </select>
          <select class="form-control pull-right" style="height: 33px; width: 150px;" name="statusAktif">
            <option value="">Status RAT</option> 
            <?php foreach($status as $key) { ?>
                <option value="<?php echo $key->statusAktif;?>"><?php echo $key->statusAktif;?></option>
            <?php } ?>
          </select> 
        </form>
          <br><br>
           ...
           <?php
                $no=1;
                  foreach ($koperasi as $key){
                      ...
                      echo "<td>". $key->tanggalRAT."</td>";
                      echo "<td>". $key->kabupaten."</td>";
                      echo "<td>". $key->jenisKoperasi."</td>";
                      echo "<td>". $key->kelompokKoperasi."</td>";
                      ?>
                  </tr>
                <?php } ?> 
          </tbody>
