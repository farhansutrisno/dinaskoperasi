					...
					<div class="media">	
						<div class="single-post">	
							<div class="single-post-thumb">	
								<img src="<?php echo base_url().'gambar_proyek/'.$berita[0]->gambar ?>" width="450px" height="550px" align="center" alt=""/>	
								<div class="post-date">
									<div class="post-date-middle">
										<span><?php echo $berita[0]->tanggalBerita ?></span>										
									</div>
								</div>
							</div>	
							<div class="blog-text">
								<div class="post-info">
									<h2 align="justify"><?php echo $berita[0]->judul ?></h2>				
								</div>								
								<p align="justify"><?php echo $berita[0]->narasi ?>.</p>
							</div>
							<a href="<?php echo base_url().'C_frontEnd/lihatBerita'?>" class="blog-readmore">Kembali</a>							
						</div>				
					</div>								
				</div>
			</div>
