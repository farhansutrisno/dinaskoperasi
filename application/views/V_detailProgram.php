					...
					<div class="media">	
						<div class="single-post">	
							<div class="single-post-thumb">	
								<img src="<?php echo base_url().'gambar_proyek/'.$program[0]->gambar ?>" width="450px" height="550px" align="center" alt=""/>	
							</div>	
							<div class="blog-text">
								<div class="post-info">
									<h2 align="justify"><?php echo $program[0]->program ?></h2>	
								</div>								
								<p align="justify"><?php echo $program[0]->isiProgramKerja ?>.</p>
							</div>
