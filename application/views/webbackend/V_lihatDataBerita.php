      ...
      <div class="row">
          ...
          <div class="box">
           ...
           <div class="col-12 page-header-title">
              <?php
                  echo anchor('webbackend/C_dataBerita/inputDataBerita','Input Data Berita',array('class'=>'btn btn-round btn-success'));
              ?>
           ...
           <?php
                $no=1;
                  foreach ($berita as $key){
                      echo "<tr>";
                      echo "<td>". $key->kdBerita."</td>";
                      echo "<td>". $key->judul."</td>";
                      
                      echo "<td>". $key->tanggalBerita."</td>";
                      ?>
                      <td>
                          <a href="<?php echo base_url().'webbackend/C_dataBerita/detaildataBerita/'.$key->kdBerita?>" class="btn btn-info"> <i class="ion ion-md-eye"></i> Detail</a>
                          <a href="<?php echo base_url().'webbackend/C_dataBerita/updateDataBerita/'.$key->kdBerita?>" class="btn btn-primary">
                          <i class="ion ion-md-create"></i> Edit</a>
                          <a href="<?php echo base_url().'webbackend/C_dataBerita/deleteDataBerita/'.$key->kdBerita?>" class="btn btn-danger"><i class="ion ion-md-trash"></i> Delete</a>
                      </td>
                  </tr>
                <?php } ?>
