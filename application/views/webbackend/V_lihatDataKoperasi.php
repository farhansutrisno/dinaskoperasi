  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
          ...
          <div class="box">
            <br>
            <form action="<?php echo base_url().'webbackend/C_dataKoperasi/dataFilter'?>" method="POST">
           <div class="col-12 page-header-title">
            <?php
                echo anchor('webbackend/C_dataKoperasi/inputDataKoperasi','Input Data Koperasi',array('class'=>'btn btn-round btn-success'));
            ?>
            <?php
                echo anchor('webbackend/C_dataKoperasi/exportAll','Export All Excel ',array('class'=>'btn btn-round btn-success'));
            ?>
            <?php
                echo anchor('webbackend/C_dataKoperasi/importDataKoperasi','Import Data Excel ',array('class'=>'btn btn-round btn-success'));
            ?>
            <br><br>
                <input type="submit" name="submit" class="btn btn-round btn-success pull-right" value="Export Excel Filter" >
                <select class="from-controll pull-right" style="height:29px; width:100px" name="bentukKoperasi">  
                    <option value="">Bentuk Koperasi</option>                 
                   <?php foreach($bentuk as $r) { ?>
                      <option value="<?php echo $r->bentukKoperasi;?>"><?php echo $r->bentukKoperasi;?></option>
                    <?php } ?>
                </select>
                <select class="from-controll pull-right" style="height:29px; width:100px" name="statusAktif">  
                    <option value="">Status Aktif</option>                 
                   <?php foreach($status as $r) { ?>
                      <option value="<?php echo $r->statusAktif;?>"><?php echo $r->statusAktif;?></option>
                    <?php } ?>
                </select>
                <select class="from-controll pull-right" style="height:29px; width:100px" name="kabupaten">  
           ...
           <?php
                $no=1;
                  foreach ($koperasi as $key){
                      echo "<tr>";
                      echo "<td>". $key->idKop."</td>";
                      echo "<td>". $key->idKoperasi."</td>";
                      echo "<td>". $key->koperasi."</td>";
                      echo "<td>". $key->noBadanHukum."</td>";
                      echo "<td>". $key->tglBadanHukum."</td>";
                      echo "<td>". $key->statusAktif."</td>";
                      echo "<td>". $key->kabupaten."</td>";
                      echo "<td>". $key->jenisKoperasi."</td>";
                      echo "<td>". $key->bentukKoperasi."</td>";
                      ?>
                      <td>
                          <a href="<?php echo base_url().'webbackend/C_dataKoperasi/detailDataKoperasi/'.$key->idKop?>" class="btn btn-info"> <i class="ion ion-md-eye"></i> Detail</a>
                          <a href="<?php echo base_url().'webbackend/C_dataKoperasi/updateDataKoperasi/'.$key->idKop?>" class="btn btn-primary">
                          <i class="ion ion-md-create"></i> Edit</a>
                          <a href="<?php echo base_url().'webbackend/C_dataKoperasi/deleteDataKoperasi/'.$key->idKop?>" class="btn btn-danger"><i class="ion ion-md-trash"></i> Delete</a>
                      </td>
                  </tr>
                <?php } ?>
					</tbody>
