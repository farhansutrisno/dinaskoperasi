    ...
    <section class="content">
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <form method="POST" action="<?php echo base_url().'webbackend/C_dataBerita/prosesInputDataBerita'?>" name="inputDataBerita" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <h5>Narasi</h5>
            <div class="controls">
              <textarea name="narasi" class="form-control" required><?php echo set_value('narasi') ?></textarea> 
