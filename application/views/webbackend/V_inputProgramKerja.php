     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <form method="POST" action="<?php echo base_url().'webbackend/C_programKerja/prosesInputProgramKerja'?>" name="inputProgramKerja" enctype="multipart/form-data">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="controls">
              <textarea name="isiProgramKerja" class="form-control" required><?php echo set_value('isiProgramKerja') ?></textarea> 
