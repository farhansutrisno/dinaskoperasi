      ...
      <div class="row">
          ...
          <div class="box">
           ...
           <div class="col-12 page-header-title">
              <?php
                  echo anchor('webbackend/C_strukturBidang/inputStruktur','Input Data Struktur',array('class'=>'btn btn-round btn-success'));
              ?>
              ...
              <?php
                $no=1;
                  foreach ($struktur as $key){
                      echo "<tr>";
                      echo "<td>". $key->kdStruktur."</td>";
                      echo "<td>". $key->jabatan."</td>";
                      echo "<td>". $key->namaPegawai."</td>";
                      ?>
                      <td>
                          <a href="<?php echo base_url().'webbackend/C_strukturBidang/detailStruktur/'.$key->kdStruktur?>" class="btn btn-info"> <i class="ion ion-md-eye"></i> Detail</a>
                          <a href="<?php echo base_url().'webbackend/C_strukturBidang/updateStruktur/'.$key->kdStruktur?>" class="btn btn-primary">
                          <i class="ion ion-md-create"></i> Edit</a>
                          <a href="<?php echo base_url().'webbackend/C_strukturBidang/deleteStruktur/'.$key->kdStruktur?>" class="btn btn-danger"><i class="ion ion-md-trash"></i> Delete</a>
                      </td>
                  </tr>
                <?php } ?> 
