      ...
      <div class="row">
          ...
          <div class="box">
           ...
           <div class="col-12 page-header-title">
              <?php
                  echo anchor('webbackend/C_programKerja/inputProgramKerja','Input Program Kerja',array('class'=>'btn btn-round btn-success'));
              ?>
              ...
              <?php
                $no=1;
                  foreach ($program as $key){
                      echo "<tr>";
                      echo "<td>". $key->kdProgram."</td>";
                      echo "<td>". $key->program."</td>";
                      ?>
                      <td>
                          <a href="<?php echo base_url().'webbackend/C_programKerja/detailProgramKerja/'.$key->kdProgram?>" class="btn btn-info"> <i class="ion ion-md-eye"></i> Detail</a>
                          <a href="<?php echo base_url().'webbackend/C_programKerja/updateProgramKerja/'.$key->kdProgram?>" class="btn btn-primary">
                          <i class="ion ion-md-create"></i> Edit</a>
                          <a href="<?php echo base_url().'webbackend/C_programKerja/deleteProgramKerja/'.$key->kdProgram?>" class="btn btn-danger"><i class="ion ion-md-trash"></i> Delete</a>
                      </td>
                  </tr>
                <?php } ?> 
