    ...
    <section class="content">
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <form method="POST" action="<?php echo base_url().'webbackend/C_dataKoperasi/upload'?>" enctype="multipart/form-data">
          <div class="row">
            <div class="col-12">
                ...
                <div class="form-group">
                  ...
                  <div>
                      ...
                      <span><i>* File harus berupa format Excel (.xlsx) </i><br> <b><?php echo anchor('assets/form_data_koperasi.xlsx','DOWNLOAD FORMAT DATA KOPERASI');?></b></span>
                  </div>
                </div>
                ...
                <div class="text-xs-right">
                  <fieldset>
                    <?php 
                        echo anchor('webbackend/C_dataKoperasi/lihatDataKoperasi','K E M B A L I',array('class'=>'btn btn-round btn-info' ));
                    ?>
