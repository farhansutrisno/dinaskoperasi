          ...
          <div class="row">
            <div class="col-6">
              <div class="table-responsive">
                ...
                <tr><th>ID Koperasi</th><td><?php echo $row[0]->idKoperasi ?></td></tr>
                <tr><th>Koperasi</th><td><?php echo $row[0]->koperasi ?></td></tr>
                <tr><th>No Badan Hukum</th><td><?php echo $row[0]->noBadanHukum ?></td></tr>
                <tr><th>TGL Badan Hukum</th><td><?php echo $row[0]->tglBadanHukum ?></td></tr>
                <tr><th>No Telpon Kantor</th><td><?php echo $row[0]->noTelpon1 ?></td></tr>
                <tr><th>Email</th><td><?php echo $row[0]->email ?></td></tr>
                <tr><th>Ketua</th><td><?php echo $row[0]->ketua ?></td></tr>
                <tr><th>No Telpon Ketua</th><td><?php echo $row[0]->noTelponKetua ?></td></tr>
                <tr><th>Bentuk Koperasi</th><td><?php echo $row[0]->bentukKoperasi ?></td></tr>
                <tr><th>Jenis Koperasi</th><td><?php echo $row[0]->jenisKoperasi ?></td></tr>
                <tr><th>Kelompok Koperasi</th><td><?php echo $row[0]->kelompokKoperasi ?></td></tr>
                <tr><th>Sektor Usaha</th><td><?php echo $row[0]->sektorUsaha ?></td></tr>
                <tr><th>Jumlah Anggota</th><td><?php echo $row[0]->jml_anggota ?></td></tr>
                <tr><th>Jumlah Karyawan</th><td><?php echo $row[0]->jml_karyawan ?></td></tr>
                <tr><th>Jumlah Manajer</th><td><?php echo $row[0]->jml_manajer ?></td></tr>
              </table>
              </div>
            </div>
            <div class="col-6">
              <div class="table-responsive">
                <table class="table table-bordered">
                <tr><th>Status Aktif</th><td><?php echo $row[0]->statusAktif ?></td></tr>
                <tr><th>Tanggal RAT</th><td><?php echo $row[0]->tanggalRAT ?></td></tr>
                <tr><th>Modal Sendiri</th><td><?php echo $row[0]->mdl_sendiri ?></td></tr>
                <tr><th>Modal Luar</th><td><?php echo $row[0]->mdl_luar ?></td></tr>
                <tr><th>Aset</th><td><?php echo $row[0]->aset ?></td></tr>
                <tr><th>SHU</th><td><?php echo $row[0]->SHU ?></td></tr>
                <tr><th>Volume Usaha</th><td><?php echo $row[0]->vlm_usaha ?></td></tr>
                <tr><th>Alamat</th><td><?php echo $row[0]->alamat ?></td></tr>
                <tr><th>Desa/Kelurahan</th><td><?php echo $row[0]->desa_kel ?></td></tr>
                <tr><th>Kecamatan</th><td><?php echo $row[0]->kecamatan ?></td></tr>
                <tr><th>Kabupaten</th><td><?php echo $row[0]->kabupaten ?></td></tr>
                <tr><th>Provinsi</th><td><?php echo $row[0]->provinsi ?></td></tr>
                <tr><th>Kode Pos</th><td><?php echo $row[0]->kodePos ?></td></tr>
                <tr><th>Tahun Rekap</th><td><?php echo $row[0]->tahunRekap ?></td></tr>
              </table>
              </div>
            </div>
            <!-- /.col -->
