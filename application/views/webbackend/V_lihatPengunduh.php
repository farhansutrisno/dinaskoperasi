      ...
      <div class="row">
          ...
          <div class="box">
           ...
           <div class="col-12 page-header-title">
            <?php
                echo anchor('webbackend/C_dataPengunduh/exportPengunduh','Export Data ALL',array('class'=>'btn btn-round btn-success'));
            ?>
            </div>
           ...
           <?php
                $no=1;
                  foreach ($pengunduh as $key){
                      ...
                      echo "<td>". $key->tglUnduh."</td>";
                      ?>
                      <td>
                          <a href="<?php echo base_url().'webbackend/C_dataPengunduh/deleteDataPengunduh/'.$key->idPengunduh?>" class="btn btn-danger"><i class="ion ion-md-trash"></i> Delete</a>
                      </td>
                  </tr>
                <?php } ?>
