          ...
          <div class="row">
            <div class="col-12">
              <div class="table-responsive">
                ...
                <tr><th>Kd Berita</th><td><?php echo $row[0]->kdBerita?></td></tr>
                <tr><th>Judul</th><td><?php echo $row[0]->judul ?></td></tr>
                <tr><th>Narasi</th><td><?php echo $row[0]->narasi ?></td></tr>
               
                <tr><th>Tanggal Berita</th><td><?php echo $row[0]->tanggalBerita ?></td></tr>
