    ...
    <section class="content">
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <form method="POST" action="<?php echo base_url().'webbackend/C_dataGaleri/prosesUpdateDataGaleri'?>" name="updateDataGaleri" enctype="multipart/form-data">

          <input type="hidden" class="form-control" name="kdGaleri" value="<?php echo $galeri[0]->kdGaleri?>" />

          <div class="form-group">
            <h5>Judul</h5>
            <div class="controls">
              <input type="text" name="judul" value="<?php echo $galeri[0]->judul ?>" class="form-control" required>
          ...
          <div class="form-group">
            <h5>Gambar</h5>
            <div>
                <span><img src="<?php echo base_url().'gambar_proyek/'.$galeri[0]->gambar ?>" height="50px" width="60px" ></span>
          ...
          <div class="text-xs-right">
            ...
            <fieldset>
             <?php echo anchor('webbackend/C_dataGaleri/lihatGaleri','K E M B A L I',array('class'=>'btn btn-round btn-info' ));?>
