...
<body class="hold-transition skin-orange-light sidebar-mini">
  ...
  <div  id="notifications"><?php echo $this->session->flashdata('notif1'); ?></div>
  <div  id="notifications"><?php echo $this->session->flashdata('notif3'); ?></div>
<div class="wrapper">
      ...
      <div class="row">
          ...
          <div class="box">
           ...
           <div class="col-12 page-header-title">
              <?php
                  echo anchor('webbackend/C_dataKoperasi/inputDaftarKoperasi','Daftar Koperasi',array('class'=>'btn btn-round btn-success'));
              ?>
        ...
        <div class="table-responsive">
          ...
          <thead>
            <tr>
              <th>NO</th>
              <th>NAMA LENGKAP</th>
              <th>NAMA KOPERASI/KELOMPOK</th>
              <th>NO TELEPON</th>
              <th>TGL DAFTAR</th>
              <th>TGL PENYULUHAN</th>
              <th>JAM PENYULUHAN</th>
              ...
              <?php
                $no=1;
                  foreach ($daftar as $key){
                      ...
                      echo "<td>". $key->namaKoperasi."</td>";
                      echo "<td>". $key->noTelepon."</td>";
                      echo "<td>". $key->tglDaftar."</td>";
                      echo "<td>". $key->tglPenyuluhan."</td>";
                      echo "<td>". $key->jamPenyuluhan."</td>";
                      echo "<td>". $key->suratPermohonan."</td>";
                      ?>
                      <td>
                          <a href="<?php echo base_url().'webbackend/C_dataKoperasi/detailDaftarKoperasi/'.$key->idPendaftar?>" class="btn btn-info"> <i class="ion ion-md-eye"></i> Detail</a>
                          <a href="<?php echo base_url().'webbackend/C_dataKoperasi/updateDaftarKoperasi/'.$key->idPendaftar?>" class="btn btn-primary">
                          <i class="ion ion-md-create"></i> Edit</a>
                          <a href="<?php echo base_url().'webbackend/C_dataKoperasi/deleteDaftarKoperasi/'.$key->idPendaftar?>" class="btn btn-danger"><i class="ion ion-md-trash"></i> Delete</a>
                      </td>
                  </tr>
                <?php } ?> 
