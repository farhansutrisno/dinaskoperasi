      ...
      <div class="row">
        <div class="col-6">
          ...
          <table class="table table-bordered">
            <tr><th>ID Pendaftar</th><td><?php echo $row[0]->idPendaftar?></td></tr>
            <tr><th>Nama Lengkap</th><td><?php echo $row[0]->namaLengkap ?></td></tr>
            
            <tr><th>NO WA/Telepon Pengurus</th><td><?php echo $row[0]->noTelepon ?></td></tr>
            <tr><th>NO WA/Telepon Kantor</th><td><?php echo $row[0]->noTelepon2 ?></td></tr>
            
            <tr><th>Alamat Pendaftar/Kantor</th><td><?php echo $row[0]->alamat ?></td></tr>
          </table>
          </div>
        </div>
        <div class="col-6">
          <div class="table-responsive">
            <table class="table table-bordered">
            <tr><th>Nama Koperasi/Kelompok</th><td><?php echo $row[0]->namaKoperasi ?></td></tr>
            <tr><th>Tanggal Daftar</th><td><?php echo $row[0]->tglDaftar ?></td></tr>
            <tr><th>Tanggal Penyuluhan</th><td><?php echo $row[0]->tglPenyuluhan ?></td></tr>
            <tr><th>Tempat Penyuluhan</th><td><?php echo $row[0]->tempatPenyuluhan ?></td></tr>
            <tr><th>Jam Penyuluhan</th><td><?php echo $row[0]->jamPenyuluhan ?></td></tr>
        ...
        <!-- /.col -->
          ...
          <div class="row">
            <div class="col-12">
              <div class="table-responsive">
                <table class="table table-bordered">
                <tr><th>Surat Permohonan</th><td></td></tr>
                <tr><td><a href="<?php echo base_url().'/gambar_proyek/'.$row[0]->suratPermohonan ?>" target="_blank"> File PDF </a></td></tr>
              </table>
              </div>
            </div>
          </div>
