    ...
    <section class="content">
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <form method="POST" action="<?php echo base_url().'webbackend/C_dataBerita/prosesUpdateDataBerita'?>" name="updateDataBerita" enctype="multipart/form-data">

          <input type="hidden" class="form-control" name="kdBerita" value="<?php echo $berita[0]->kdBerita?>" />

          <div class="form-group">
            <h5>Judul</h5>
            <div class="controls">
              <input type="text" name="judul" value="<?php echo $berita[0]->judul ?>" class="form-control" required> 
            <?php echo form_error('judul'); ?></div>
          </div>

          <div class="form-group">
            <h5>Narasi</h5>
            <div class="controls">
               <textarea required class="form-control" name="narasi" rows="5"><?php echo $berita[0]->narasi ?></textarea> 
             <?php echo form_error('narasi'); ?></div>
          </div>

          <div class="form-group">
            <h5>Gambar</h5>
            <div>
                <span><img src="<?php echo base_url().'gambar_proyek/'.$berita[0]->gambar ?>" height="50px" width="60px" ></span>
          ...
          <div class="text-xs-right">
            ...
            <fieldset>
             <?php echo anchor('webbackend/C_dataBerita/lihatBerita','K E M B A L I',array('class'=>'btn btn-round btn-info' ));?>
