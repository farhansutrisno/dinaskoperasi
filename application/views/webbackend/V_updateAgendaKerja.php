    ...
    <section class="content">
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <form method="POST" action="<?php echo base_url().'webbackend/C_agendaKerja/prosesUpdateAgendaKerja'?>" name="updateAgendakerja" enctype="multipart/form-data">

          <input type="hidden" class="form-control" name="kdAgenda" value="<?php echo $agenda[0]->kdAgenda?>" />

          <div class="form-group">
            <h5>Agenda Kerja</h5>
            <div class="controls">
              <input type="text" name="agenda" value="<?php echo $agenda[0]->agenda ?>" class="form-control" required>
              <?php echo form_error('agenda'); ?> </div>
          </div>

          <div class="form-group">
            <h5>Isi Agenda Kerja</h5>
            <div class="controls">
               <textarea required class="form-control" name="isiAgendaKerja" rows="5"><?php echo $agenda[0]->isiAgendaKerja ?></textarea> 
               <?php echo form_error('isiAgendaKerja'); ?></div>
          </div>

          <div class="form-group">
            <h5>Gambar</h5>
            <div>
                <span><img src="<?php echo base_url().'gambar_proyek/'.$agenda[0]->gambar ?>" height="50px" width="60px" ></span>
          ...
          <div class="text-xs-right">
            ...
            <fieldset>
             <?php echo anchor('webbackend/C_agendaKerja/lihatAgendaKerja','K E M B A L I',array('class'=>'btn btn-round btn-info' ));?>
