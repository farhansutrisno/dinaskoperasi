    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li>
        ...
        <li>
          <a href="<?php echo base_url() ?>webbackend/C_dataKoperasi/lihatDataKoperasi">
    ...
    <section class="content">
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <form method="POST" action="<?php echo base_url().'webbackend/C_programKerja/prosesUpdateProgramKerja'?>" name="updateProgramkerja" enctype="multipart/form-data">

          <input type="hidden" class="form-control" name="kdProgram" value="<?php echo $program[0]->kdProgram?>" />

          <div class="form-group">
            <h5>Program Kerja</h5>
            <div class="controls">
              <input type="text" name="program" value="<?php echo $program[0]->program ?>" class="form-control" required>
              <?php echo form_error('program'); ?> </div>
          </div>

          <div class="form-group">
            <h5>Isi Program Kerja</h5>
            <div class="controls">
               <textarea required class="form-control" name="isiProgramKerja" rows="5"><?php echo $program[0]->isiProgramKerja ?></textarea> 
             <?php echo form_error('isiProgramKerja'); ?></div>
          </div>

          <div class="form-group">
            <h5>Gambar</h5>
            <div>
                <span><img src="<?php echo base_url().'gambar_proyek/'.$program[0]->gambar ?>" height="50px" width="60px" ></span>
          ...
          <div class="text-xs-right">
            ...
            <fieldset>
             <?php echo anchor('webbackend/C_programKerja/lihatProgramKerja','K E M B A L I',array('class'=>'btn btn-round btn-info' ));?>
