...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Form Update Struktur Bidang Kelembagaan Koperasi
      </h1>
    ...
    <section class="content">
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <form method="POST" action="<?php echo base_url().'webbackend/C_strukturBidang/prosesUpdateStruktur'?>" name="updateStruktur" enctype="multipart/form-data">

          <input type="hidden" class="form-control" name="kdStruktur" value="<?php echo $struktur[0]->kdStruktur?>" />

          <div class="form-group">
            <h5>Nama Lengkap</h5>
            <div class="controls">
              <input type="text" name="namaPegawai" value="<?php echo $struktur[0]->namaPegawai ?>" class="form-control" required> <?php echo form_error('namaPegawai'); ?></div>
          </div>

          <div class="form-group">
            <h5>NIP</h5>
            <div class="controls">
              <input type="number" name="nip" value="<?php echo $struktur[0]->nip ?>" class="form-control" required> 
          ...
          <div class="form-group">
            ...
            <div class="controls">
              <select name="jabatan"  required class="form-control">
                 <option><?php echo $struktur[0]->jabatan ?></option>
          ...
          <div class="form-group">
            ...
            <div class="controls">
              <select name="bagian"  required class="form-control">
                 <option><?php echo $struktur[0]->bagian ?></option>
          ...
          <div class="form-group">
            <h5>Foto</h5>
            <div>
                <span><img src="<?php echo base_url().'gambar_proyek/'.$struktur[0]->foto ?>" height="50px" width="60px" ></span>
