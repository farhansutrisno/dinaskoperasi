          ...
          <div class="row">
            <div class="col-6">
              <div class="table-responsive">
                ...
                <tr><th>KD PESAN MASUK</th><td><?php echo $row[0]->kdPesanMasuk?></td></tr>
            ...
            <div class="col-6">
              <div class="table-responsive">
                <table class="table table-bordered">
                <tr><th>JUDUL PESAN</th><td><?php echo $row[0]->judulPesan ?></td></tr>
                <tr><th>ISI PESAN</th><td><?php echo $row[0]->isiPesan ?></td></tr>
                <tr><th>TANGGAL PESAN</th><td><?php echo $row[0]->tanggalPesan ?></td></tr>
              </table>
              </div>
            </div>
            <!-- /.col -->
