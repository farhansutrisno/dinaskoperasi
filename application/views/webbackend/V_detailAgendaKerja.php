...
<div class="wrapper">
          ...
          <div class="row">
            <div class="col-12">
              <div class="table-responsive">
                ...
                <tr><th>Kd Agenda</th><td><?php echo $row[0]->kdAgenda?></td></tr>
                <tr><th>Agenda Kerja</th><td><?php echo $row[0]->agenda ?></td></tr>
                <tr><th>Isi Agenda Kerja</th><td><?php echo $row[0]->isiAgendaKerja ?></td></tr>
                <tr><th>Gambar</th><td></td></tr>
              </table>
              </div>
              <img src="<?php echo base_url().'gambar_proyek/'.$row[0]->gambar ?>" width="600px" height="500px">
            </div>
            <!-- /.col -->
          </div>
          <br>
  ...
  <footer class="main-footer">
    ...
    </div>Copyright &copy; Farhan Sutrisno 2019 All Rights Reserved.
  </footer>
