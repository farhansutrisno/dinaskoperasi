     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <form method="POST" action="<?php echo base_url().'webbackend/C_agendaKerja/prosesInputAgendaKerja'?>" name="inputAgendaKerja" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <h5>Agenda Kerja</h5>
            <div class="controls">
              <input type="text" name="agenda" class="form-control" value="<?php echo set_value('agenda') ?>" required>
           ...
           <div class="form-group">
            ...
            <div class="controls">
              <textarea name="isiAgendaKerja" class="form-control" required><?php echo set_value('isiAgendaKerja') ?></textarea>
