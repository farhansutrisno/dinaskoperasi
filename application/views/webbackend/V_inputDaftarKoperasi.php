     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <form method="POST" action="<?php echo base_url().'webbackend/C_dataKoperasi/prosesInputDaftarKoperasi'?>" enctype="multipart/form-data">
          <div class="row">
            <div class="col-6">
                ...
                <div class="form-group">
                  <h5>Nama Koperasi/Kelompok</h5>
                  <div class="controls">
                    <input type="text" name="namaKoperasi" class="form-control" value="<?php echo set_value('namaKoperasi') ?>" required> 
                  <?php echo form_error('namaKoperasi'); ?></div>
                </div>

                <div class="form-group">
                  <h5>No WA/Telepon Pengurus</h5>
                  <div class="controls">
                ...
                <div class="form-group">
                  <h5>No WA/Telepon Kantor</h5>
                  <div class="controls">
                    <input type="number" name="noTelepon2" class="form-control" value="<?php echo set_value('noTelepon2') ?>" required> 
                  <?php echo form_error('noTelepon2'); ?></div>
                </div>

                <div class="form-group">
                  <h5>Alamat Pendaftar/Kantor</h5>
                  <div class="controls">
                    <textarea name="alamat" class="form-control" required><?php echo set_value('alamat') ?></textarea> 
            ...
            <div class="col-6">
              ...
              <div class="form-group">
                  ...
                  <div class="controls">
                      <input class="form-control datepicker"  data-date-format="yyyy-mm-dd" type="text" value="<?php echo set_value('tglPenyuluhan') ?>" name="tglPenyuluhan" required> 
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <input type="text" name="jamPenyuluhan" class="form-control" value="<?php echo set_value('jamPenyuluhan') ?>" required> 
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <textarea name="tempatPenyuluhan" class="form-control"  required><?php echo set_value('tempatPenyuluhan') ?></textarea> <?php echo form_error('tempatPenyuluhan'); ?></div>
              </div>
