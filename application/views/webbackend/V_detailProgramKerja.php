          ...
          <div class="row">
            <div class="col-12">
              <div class="table-responsive">
                ...
                <tr><th>Kd Program</th><td><?php echo $row[0]->kdProgram?></td></tr>
                <tr><th>Program Kerja</th><td><?php echo $row[0]->program ?></td></tr>
                <tr><th>Isi Program Kerja</th><td><?php echo $row[0]->isiProgramKerja ?></td></tr>
