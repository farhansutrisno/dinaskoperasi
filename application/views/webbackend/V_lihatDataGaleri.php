      ...
      <div class="row">
          ...
          <div class="box">
           ...
           <div class="col-12 page-header-title">
              <?php
                  echo anchor('webbackend/C_dataGaleri/inputDataGaleri','Input Data Galeri',array('class'=>'btn btn-round btn-success'));
              ?>
           ...
           <?php
                $no=1;
                  foreach ($galeri as $key){
                      ...
                      echo "<td>". $key->tanggalGaleri."</td>";
                      ?>
                      <td>
                          <a href="<?php echo base_url().'webbackend/C_dataGaleri/detailDataGaleri/'.$key->kdGaleri?>" class="btn btn-info"> <i class="ion ion-md-eye"></i> Detail</a>
                          <a href="<?php echo base_url().'webbackend/C_dataGaleri/updateDataGaleri/'.$key->kdGaleri?>" class="btn btn-primary">
                          <i class="ion ion-md-create"></i> Edit</a>
                          <a href="<?php echo base_url().'webbackend/C_dataGaleri/deleteDataGaleri/'.$key->kdGaleri?>" class="btn btn-danger"><i class="ion ion-md-trash"></i> Delete</a>
                      </td>
                  </tr>
                <?php } ?>
