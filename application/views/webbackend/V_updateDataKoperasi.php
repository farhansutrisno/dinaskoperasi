    ...
    <section class="content">
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <form method="POST" action="<?php echo base_url().'webbackend/C_dataKoperasi/prosesUpdateDataKoperasi'?>" name="updateDataKoperasi">
          <div class="row">
            <input type="hidden" name="idKop" value="<?php echo $koperasi[0]->idKop ?>">
            <div class="col-6">
              <div class="form-group">
                <h5>ID Koperasi</h5>
                <div class="controls">
                  <input type="text" name="idKoperasi" value="<?php echo $koperasi[0]->idKoperasi ?>" class="form-control" required> <?php echo form_error('idKoperasi'); ?></div>            
              </div>

              <div class="form-group">
                <h5>Nama Koperasi</h5>
                <div class="controls">
                  <input type="text" name="koperasi" value="<?php echo $koperasi[0]->koperasi ?>" class="form-control" required> 
                <?php echo form_error('koperasi'); ?></div>
              </div>

              <div class="form-group">
                <h5>No Badan Hukum</h5>
                <div class="controls">
                  <input type="text" name="noBadanHukum" value="<?php echo $koperasi[0]->noBadanHukum ?>" class="form-control" required>
                  <?php echo form_error('noBadanHukum'); ?></div>
              </div>

              <div class="form-group">
                  <h5>Tanggal Badan Hukum</h5>
                  <div class="controls">
                      <input class="form-control datepicker" style="width:335px;" size="30" data-date-format="yyyy-mm-dd" type="text" name="tglBadanHukum" value="<?php echo $koperasi[0]->tglBadanHukum ?>" > 
                      <?php echo form_error('tglBadanHukum'); ?>
                  </div>
              </div>

              <div class="form-group">
                <h5>No Telpon Kantor</h5>
                <div class="controls">
                  <input type="number" name="noTelepon1" value="<?php echo $koperasi[0]->noTelpon1 ?>" class="form-control" required>
                  <?php echo form_error('noTelepon1'); ?></div> 
              </div>

              <div class="form-group">
                <h5>Email</h5>
                <div class="controls">
                  <input type="email" name="email" value="<?php echo $koperasi[0]->email ?>" class="form-control" required>
              ...
              <div class="form-group">
                <h5>Ketua</h5>
                <div class="controls">
                  <input type="text" name="ketua" value="<?php echo $koperasi[0]->ketua ?>" class="form-control" required> 
                <?php echo form_error('ketua'); ?></div>
              </div>

              <div class="form-group">
                <h5>No Telepon Ketua</h5>
                <div class="controls">
                  <input type="number" name="noTelpKetua" value="<?php echo $koperasi[0]->noTelponKetua ?>" class="form-control" required>
                  <?php echo form_error('noTelpKetua'); ?></div> 
              </div>
             
              <div class="form-group">
                <h5>Bentuk Koperasi </h5>
                <div class="controls">
                  <select name="bentukKoperasi" class="form-control">
                    <option><?php echo $koperasi[0]->bentukKoperasi ?></option>
                    <option>Primer Provinsi</option>
                    <option>Sekunder Provinsi</option>
                    <option>Primer Kabupaten/Kota</option>
                    <option>Sekunder Kabupaten/Kota</option>
                  </select>
                  <?php echo form_error('bentukKoperasi'); ?>
                </div>
              </div>

              <div class="form-group">
                <h5>Jenis Koperasi </h5>
                <div class="controls">
                  <select name="jenisKoperasi" class="form-control">
                    <option><?php echo $koperasi[0]->jenisKoperasi ?></option>
                  ...
                  <?php echo form_error('jenisKoperasi'); ?>
                </div>
              </div>

              <div class="form-group">
                <h5>Kelompok Koperasi</h5>
                  <div class="controls">
                    <select name="kelKoperasi" class="form-control">
                      <option><?php echo $koperasi[0]->kelompokKoperasi ?></option>
                      <option>Kop. Simpan Pinjam dan pembiayaan Syariah</option>
                      <option>Kop. Simpan Pinjam</option>
                      <option>Kop. Wredatama</option>
                      <option>Kop. Pertanian</option>
                      <option>Kopkar</option>
                      <option>Kop. Peternakan</option>
                      <option>Kop. Angkutan Darat</option>
                      <option>Kop. Perumahan</option>
                      <option>Kop. Serba Usaha</option>
                    </select>
                    <?php echo form_error('kelKoperasi'); ?>
                  </div>
              </div>
              ...
              <div class="form-group">
                <h5>Sektor Usaha</h5>
                <div class="controls">
                  <input type="text" name="sektorUsaha" value="<?php echo $koperasi[0]->sektorUsaha ?>" class="form-control" required> 
                <?php echo form_error('sektorUsaha'); ?></div>
              </div>

              <div class="form-group">
                <h5>Modal Sendiri</h5>
                <div class="controls">
                  <input type="number" name="mdl_sendiri" value="<?php echo $koperasi[0]->mdl_sendiri ?>" class="form-control">
                  <?php echo form_error('mdl_sendiri'); ?> </div>
              </div>

              <div class="form-group">
                <h5>Modal Luar</h5>
                <div class="controls">
                  <input type="number" name="mdl_luar" value="<?php echo $koperasi[0]->mdl_luar ?>" class="form-control">
                  <?php echo form_error('mdl_luar'); ?> </div>
              </div>

              <div class="form-group">
                  <h5>Aset</h5>
                  <div class="controls">
                    <input type="number" name="aset" value="<?php echo $koperasi[0]->aset ?>" class="form-control">
                    <?php echo form_error('aset'); ?> </div>
                </div>

              <div class="text-xs-right">
                <fieldset>
                   <?php echo anchor('webbackend/C_dataKoperasi/lihatDataKoperasi','K E M B A L I',array('class'=>'btn btn-round btn-info' ));?>
              ...
              <div class="col-6">
                ...
                <div class="form-group">
                  <h5>Volume Usaha</h5>
                  <div class="controls">
                    <input type="number" name="vlm_usaha" value="<?php echo $koperasi[0]->vlm_usaha ?>" class="form-control"> 
                  <?php echo form_error('vlm_usaha'); ?></div>
                </div>

                <div class="form-group">
                  <h5>SHU</h5>
                  <div class="controls">
                    <input type="number" name="shu" value="<?php echo $koperasi[0]->SHU ?>" class="form-control"> 
                  <?php echo form_error('shu'); ?></div>
                </div>

                <div class="form-group">
                  <h5>Jumlah Anggota</h5>
                  <div class="controls">
                    <input type="number" name="jml_anggota" value="<?php echo $koperasi[0]->jml_anggota ?>" class="form-control">
                    <?php echo form_error('jml_anggota'); ?> </div>
                </div>

                <div class="form-group">
                  <h5>Jumlah Karyawan</h5>
                  <div class="controls">
                    <input type="number" name="jml_karyawan" value="<?php echo $koperasi[0]->jml_karyawan ?>" class="form-control"> 
                    <?php echo form_error('jml_karyawan'); ?></div>
                </div>

                <div class="form-group">
                  <h5>Jumlah Manajer</h5>
                  <div class="controls">
                    <input type="number" name="jml_manajer" value="<?php echo $koperasi[0]->jml_manajer ?>" class="form-control"> 
                    <?php echo form_error('jml_manajer'); ?></div>
                </div>

                <div class="form-group">
                    <h5>Tanggal RAT</h5>
                    <div class="controls">
                        <input class="form-control datepicker" style="width:335px;" size="30" data-date-format="yyyy-mm-dd" type="text" name="tglRAT" value="<?php echo $koperasi[0]->tanggalRAT ?>" > 
                        <?php echo form_error('tglRAT'); ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="controls">
                    <select name="statusAktif" class="form-control">
                      <option><?php echo $koperasi[0]->statusAktif ?></option>
                      <option>Aktif</option>
                      <option>Tidak Aktif</option>
                    </select>
                    <?php echo form_error('statusAktif'); ?>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <h5>Alamat</h5>
                  <div class="controls">
                    <input type="text" name="alamat" value="<?php echo $koperasi[0]->alamat ?>" class="form-control" required> 
                ...
                <div class="form-group">
                  ...
                  <div class="controls">
                    <input type="text" name="desa_kel" value="<?php echo $koperasi[0]->desa_kel ?>" class="form-control" required> 
                    <?php echo form_error('desa_kel'); ?></div>
                </div>

                <div class="form-group">
                  <h5>Kecamatan</h5>
                  <div class="controls">
                    <input type="text" name="kecamatan" value="<?php echo $koperasi[0]->kecamatan ?>" class="form-control" required> <?php echo form_error('kecamatan'); ?></div>
                </div>

                <div class="form-group">
                  <h5>Kabupaten</h5>
                  <div class="controls">
                    <select name="kabupaten" required class="form-control">
                        <option><?php echo $koperasi[0]->kabupaten ?></option>
                ...
                <div class="form-group">
                  <h5>Provinsi</h5>
                  <div class="controls">
                    <input type="text" name="provinsi" value="<?php echo $koperasi[0]->provinsi ?>" class="form-control" required> 
                ...
                <div class="form-group">
                  <h5>Kode Pos</h5>
                  <div class="controls">
                    <input type="number" name="kodePos" value="<?php echo $koperasi[0]->kodePos ?>" class="form-control" required> 
                    <?php echo form_error('kodePos'); ?></div>
                </div>

                <div class="form-group">
                  <h5>Tahun Rekap</h5>
                  <div class="controls">
                    <input type="number" name="tahunRekap" value="<?php echo $koperasi[0]->tahunRekap ?>" class="form-control" required> 
                    <?php echo form_error('tahunRekap'); ?></div>
                </div>
