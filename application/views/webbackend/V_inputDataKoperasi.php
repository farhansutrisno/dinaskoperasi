     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <form method="POST" action="<?php echo base_url().'webbackend/C_dataKoperasi/prosesInputDataKoperasi'?>" name="inputDataKoperasi">
          <div class="row">
            <div class="col-6">
                <div class="form-group">
                  <h5>ID Koperasi</h5>
                  <div class="controls">
                    <input type="text" name="idKop" class="form-control" value="<?php echo set_value('idKop') ?>" required>
                    <?php echo form_error('idKop'); ?> </div>
                </div>

                <div class="form-group">
                  <h5>Nama Koperasi</h5>
                  <div class="controls">
                    <input type="text" name="koperasi" class="form-control" value="<?php echo set_value('koperasi') ?>" required>
                ...
                <div class="form-group">
                  ...
                  <div class="controls">
                    <input type="text" name="noBadanHukum" class="form-control" value="<?php echo set_value('noBadanHukum') ?>" required> 
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input class="form-control datepicker" style="width:335px;" size="30" data-date-format="yyyy-mm-dd" type="text" name="tglBadanHukum" value="<?php echo set_value('tglBadanHukum') ?>" required> 
                ...
                <div class="form-group">
                  ...
                  <div class="controls">
                    <input type="number" name="noTelepon1" class="form-control" value="<?php echo set_value('noTelepon1') ?>" required> 
                ...
                <div class="form-group">
                  <h5>Ketua</h5>
                  <div class="controls">
                    <input type="text" name="ketua" class="form-control" value="<?php echo set_value('ketua') ?>" required> 
                  <?php echo form_error('ketua'); ?></div>
                </div>

                <div class="form-group">
                  <h5>No HP Pengurus</h5>
                  <div class="controls">
                    <input type="number" name="noTelpKetua" class="form-control" value="<?php echo set_value('noTelpKetua') ?>" required> <?php echo form_error('noTelpKetua'); ?></div>
                </div>
               
                <div class="form-group">
                  <h5>Bentuk Koperasi </h5>
                  <div class="controls">
                    <select name="bentukKoperasi" required class="form-control">
                      
                      <option><?php echo set_value('bentukKoperasi') ?></option>
                ...
                <div class="form-group">
                  ...
                  <div class="controls">
                    <select name="jenisKoperasi" required class="form-control">
                      
                      <option><?php echo set_value('jenisKoperasi') ?></option>
                ...
                <div class="form-group">
                  ...
                  <div class="controls">
                    <select name="kelKoperasi" required class="form-control">
                      
                      <option><?php echo set_value('kelKoperasi') ?></option>
                ...
                <div class="form-group">
                  <h5>Sektor Usaha</h5>
                  <div class="controls">
                    <input type="text" name="sektorUsaha" class="form-control" value="<?php echo set_value('sektorUsaha') ?>" required> 
                ...
                <div class="form-group">
                  <h5>Modal Sendiri</h5>
                  <div class="controls">
                    <input type="number" name="mdl_sendiri" class="form-control" value="<?php echo set_value('mdl_sendiri') ?>" required> <?php echo form_error('mdl_sendiri'); ?></div>
                </div>

                <div class="form-group">
                  <h5>Modal Luar</h5>
                  <div class="controls">
                    <input type="number" name="mdl_luar" class="form-control" value="<?php echo set_value('mdl_luar') ?>" required> 
                ...
                <div class="form-group">
                  <h5>Aset</h5>
                  <div class="controls">
                    <input type="number" name="aset" class="form-control" value="<?php echo set_value('aset') ?>" required> 
            ...
            <div class="col-6">
                ...
                <div class="form-group">
                  <h5>Volume Usaha</h5>
                  <div class="controls">
                    <input type="number" name="vlm_usaha" class="form-control" value="<?php echo set_value('vlm_usaha') ?>" required> 
                ...
                <div class="form-group">
                  <h5>SHU</h5>
                  <div class="controls">
                    <input type="number" name="shu" class="form-control" value="<?php echo set_value('shu') ?>" required> 
                ...
                <div class="form-group">
                  ...
                  <div class="controls">
                    <input type="number" name="jml_anggota" class="form-control" value="<?php echo set_value('jml_anggota') ?>" required> <?php echo form_error('jml_anggota'); ?></div>
                </div>

                <div class="form-group">
                  <h5>Jumlah Karyawan</h5>
                  <div class="controls">
                    <input type="number" name="jml_karyawan" class="form-control" value="<?php echo set_value('jml_karyawan') ?>" required> 
                ...
                <div class="form-group">
                  ...
                  <div class="controls">
                    <input type="number" name="jml_manajer" class="form-control" value="<?php echo set_value('jml_manajer') ?>" required> <?php echo form_error('jml_manajer'); ?></div>
                </div>

                <div class="form-group">
                    <h5>Tanggal RAT</h5>
                    <div class="controls">
                        <input class="form-control datepicker" style="width:335px;" size="30" data-date-format="yyyy-mm-dd" type="text" name="tglRAT" value="<?php echo set_value('tglRAT') ?>" required> 
                ...
                <div class="form-group">
                  <h5>Status Aktif </h5>
                  <div class="controls">
                    <select name="statusAktif" required class="form-control">
                      
                      <option><?php echo set_value('statusAktif') ?></option>
                      <option>TRUE</option>
                      <option>FALSE</option>
                    </select>
                ...
                <div class="form-group">
                  ...
                  <div class="controls">
                    <input type="text" name="desa_kel" class="form-control" value="<?php echo set_value('desa_kel') ?>" required>
                ...
                <div class="form-group">
                  <h5>Kecamatan</h5>
                  <div class="controls">
                    <input type="text" name="kecamatan" class="form-control" value="<?php echo set_value('kecamatan') ?>" required>
                ...
                <div class="form-group">
                  ...
                  <div class="controls">
                    <select name="kabupaten" required class="form-control">
                        ...
                        <option><?php echo set_value('kabupaten') ?></option>
                ...
                <div class="form-group">
                  <h5>Provinsi</h5>
                  <div class="controls">
                    <input type="text" name="provinsi" class="form-control" value="<?php echo set_value('provinsi') ?>" required> 
                ...
                <div class="form-group">
                  <h5>Kode Pos</h5>
                  <div class="controls">
                    <input type="number" name="kodePos" class="form-control" value="<?php echo set_value('kodePos') ?>" required> 
                ...
                <div class="form-group">
                  <h5>Tahun Rekap</h5>
                  <div class="controls">
                    <input type="number" name="tahunRekap" class="form-control" value="<?php echo set_value('tahunRekap') ?>" required> 
