    ...
    <section class="content">
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form method="POST" action="<?php echo base_url().'webbackend/C_dataKoperasi/prosesUpdateDaftarKoperasi'?>" enctype="multipart/form-data">
          <div class="row">
            <div class="col-6">

              <input type="hidden" class="form-control" name="idPendaftar" value="<?php echo $daftar[0]->idPendaftar?>" />
              <div class="form-group">
                <h5>Nama Lengkap</h5>
                <div class="controls">
                  <input type="text" name="namaLengkap" value="<?php echo $daftar[0]->namaLengkap ?>" class="form-control" required>
              ...
              <div class="form-group">
                <h5>Nama koperasi</h5>
                <div class="controls">
                  <input type="text" name="namaKoperasi" value="<?php echo $daftar[0]->namaKoperasi ?>" class="form-control" required> 
                <?php echo form_error('namaKoperasi'); ?></div>
              </div>

              <div class="form-group">
                <h5>No Telepon/WA</h5>
                <div class="controls">
                  <input type="text" name="noTelepon" value="<?php echo $daftar[0]->noTelepon ?>" class="form-control" required>
                  <?php echo form_error('noTelepon'); ?> </div>
              </div>

              <div class="form-group">
                <h5>No Telepon/WA Kantor</h5>
                <div class="controls">
                  <input type="text" name="noTelepon2" value="<?php echo $daftar[0]->noTelepon2 ?>" class="form-control" required>
                  <?php echo form_error('noTelepon2'); ?> </div>
              </div>

              <div class="form-group">
                  <h5>Alamat Pendaftar</h5>
                  <div class="controls">
                    <textarea name="alamat" class="form-control" required><?php echo $daftar[0]->alamat ?></textarea> 
              ...
              <div class="text-xs-right">
                ...
                <fieldset>
                 <?php echo anchor('webbackend/C_dataKoperasi/lihatDaftarKoperasi','K E M B A L I',array('class'=>'btn btn-round btn-info' ));?>
            ...
            <div class="col-6">
              ...
              <div class="form-group">
                <h5>Tanggal Penyuluhan</h5>
                <div class="controls">
                    <input class="form-control datepicker" style="width:335px;" size="30" data-date-format="yyyy-mm-dd" type="text" name="tglPenyuluhan" value="<?php echo $daftar[0]->tglPenyuluhan ?>" > 
                    <?php echo form_error('tglPenyuluhan'); ?>
                </div>
              </div>

              <div class="form-group">
                <h5>Jam Penyuluhan</h5>
                <div class="controls">
                  <input type="text" name="jamPenyuluhan" value="<?php echo $daftar[0]->jamPenyuluhan ?>" class="form-control"> 
                <?php echo form_error('jamPenyuluhan'); ?></div>
              </div>

              <div class="form-group">
                  <h5>Tempat Penyuluhan</h5>
                  <div class="controls">
                    <textarea name="tempatPenyuluhan" class="form-control" required><?php echo $daftar[0]->tempatPenyuluhan ?></textarea>
                    <?php echo form_error('tempatPenyuluhan'); ?> </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div>
                    ...
                    <span><i>Format file : JPG/PNG/PDF/JPEG/GIF | Maksimal Upload : 10 Mb</i></span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-12">
                <span><embed src="<?php echo base_url().'gambar_proyek/'.$daftar[0]->suratPermohonan ?>" height="650px" width="520px" type="application/pdf" /></span>
            </div>
          </div>
        </form>
