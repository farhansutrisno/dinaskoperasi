...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Detail Struktur Bidang Kelembagaan Koperasi
      </h1>
          ...
          <div class="row">
            <div class="col-12">
              <div class="table-responsive">
                ...
                <tr><th>Kd Struktur</th><td><?php echo $row[0]->kdStruktur?></td></tr>
                <tr><th>Nama Pegawai</th><td><?php echo $row[0]->namaPegawai ?></td></tr>
                <tr><th>NIP</th><td><?php echo $row[0]->nip ?></td></tr>
                <tr><th>Jabatan</th><td><?php echo $row[0]->jabatan ?></td></tr>
                <tr><th>Bagian</th><td><?php echo $row[0]->bagian ?></td></tr>
                <tr><th>Foto</th><td></td></tr>
              </table>
              </div>
              <img src="<?php echo base_url().'gambar_proyek/'.$row[0]->foto ?>" width="600px" height="500px">
            </div>
            <!-- /.col -->
          </div>
          <br>
