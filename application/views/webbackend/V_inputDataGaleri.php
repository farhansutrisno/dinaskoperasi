    ...
    <section class="content">
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <form method="POST" action="<?php echo base_url().'webbackend/C_dataGaleri/prosesInputDataGaleri'?>" name="inputDataBerita" enctype="multipart/form-data">
